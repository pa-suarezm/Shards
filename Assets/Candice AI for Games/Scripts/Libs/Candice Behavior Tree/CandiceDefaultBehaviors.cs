...
namespace CandiceAIforGames.AI
{
    ...
    public class CandiceDefaultBehaviors
    {
        ...
        public static CandiceBehaviorStates MoveTo(CandiceBehaviorNode rootNode)
        {
            CandiceAIController agent = rootNode.aiController;
            agent.IsMoving = true;
            CandiceBehaviorStates state = CandiceBehaviorStates.SUCCESS;
            try
            {
                agent.movementModule.MoveTowards2D(agent.transform, agent);
        ...
        public static CandiceBehaviorStates Patrol(CandiceBehaviorNode rootNode)
        {
            CandiceAIController agent = rootNode.aiController;
            agent.IsMoving = true;
            CandiceBehaviorStates state = CandiceBehaviorStates.SUCCESS;
        ...
        public static CandiceBehaviorStates Seek(CandiceBehaviorNode rootNode)
        {
            CandiceAIController agent = rootNode.aiController;
            agent.IsMoving = true;
            CandiceBehaviorStates state = CandiceBehaviorStates.SUCCESS;
            try
            {
                agent.movementModule.Seek(agent.transform, agent);
        ...
        public static CandiceBehaviorStates Orbit(CandiceBehaviorNode rootNode)
        {
            CandiceAIController agent = rootNode.aiController;
            agent.IsMoving = true;
            CandiceBehaviorStates state = CandiceBehaviorStates.SUCCESS;
            try
            {
                agent.movementModule.Orbit(agent.transform, agent);
        ...
        public static CandiceBehaviorStates Rotate(CandiceBehaviorNode rootNode)
        {
            CandiceAIController agent = rootNode.aiController;
            agent.IsMoving = true;
            CandiceBehaviorStates state = CandiceBehaviorStates.SUCCESS;
            try
            {
                agent.movementModule.Rotate(agent.transform, agent);
